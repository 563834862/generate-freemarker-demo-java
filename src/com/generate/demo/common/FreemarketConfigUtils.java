...
public class FreemarketConfigUtils {
    ...
    public final static int TYPE_API_ADD_MODIFY = 6;
    public final static int TYPE_API_DELETE = 7;
    public final static int TYPE_API_ONE = 8;
    public final static int TYPE_API_PAGE = 9;
    public final static int TYPE_API_LIST = 10;
